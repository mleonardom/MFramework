...
class MF_PHPExcel
{
	 ...
	 * Document properties
	 *
	 * @var MF_PHPExcel_DocumentProperties
	 */
	private $_properties;
	 ...
	 * Document security
	 *
	 * @var MF_PHPExcel_DocumentSecurity
	 */
	private $_security;
	...
	/**
	 * Create a new MF_PHPExcel with one Worksheet
	 */
	public function __construct()
	{
		// Initialise worksheet collection and add one worksheet
		$this->_workSheetCollection = array();
		$this->_workSheetCollection[] = new MF_PHPExcel_Worksheet($this);
		$this->_activeSheetIndex = 0;

		// Create document properties
		$this->_properties = new MF_PHPExcel_DocumentProperties();

		// Create document security
		$this->_security = new MF_PHPExcel_DocumentSecurity();

		// Set named ranges
		$this->_namedRanges = array();

		// Create the cellXf supervisor
		$this->_cellXfSupervisor = new MF_PHPExcel_Style(true);
		$this->_cellXfSupervisor->bindParent($this);

		// Create the default style
		$this->addCellXf(new MF_PHPExcel_Style);
		$this->addCellStyleXf(new MF_PHPExcel_Style);
	}
	 ...
	 * Get properties
	 *
	 * @return MF_PHPExcel_DocumentProperties
	 */
	 ...
	 * Set properties
	 *
	 * @param MF_PHPExcel_DocumentProperties	$pValue
	 */
	public function setProperties(MF_PHPExcel_DocumentProperties $pValue)
	{
	 ...
	 * Get security
	 *
	 * @return MF_PHPExcel_DocumentSecurity
	 */
	 ...
	 * Set security
	 *
	 * @param MF_PHPExcel_DocumentSecurity	$pValue
	 */
	public function setSecurity(MF_PHPExcel_DocumentSecurity $pValue)
	{
    ...
    {
        $newSheet = new MF_PHPExcel_Worksheet($this);
     ...
     * @throws Exception
     */
    public function addSheet(MF_PHPExcel_Worksheet $pSheet = null, $iSheetIndex = null)
    {
	 ...
	 * @throws Exception
	 */
	public function getIndex(MF_PHPExcel_Worksheet $pSheet)
	{
	...
	{
		if (($worksheet = $this->getSheetByName($pValue)) instanceof MF_PHPExcel_Worksheet) {
	 ...
	 * Add external sheet
	 *
	 * @param MF_PHPExcel_Worksheet $pSheet External sheet to add
	 * @param int|null $iSheetIndex Index where sheet should go (0,1,..., or null for last)
	 * @throws Exception
	 * @return MF_PHPExcel_Worksheet
	 */
	public function addExternalSheet(MF_PHPExcel_Worksheet $pSheet, $iSheetIndex = null) {
	 ...
	 * Add named range
	 *
	 * @param MF_PHPExcel_NamedRange $namedRange
	 * @return MF_PHPExcel
	 */
	public function addNamedRange(MF_PHPExcel_NamedRange $namedRange) {
	 ...
	 * @return MF_PHPExcel_NamedRange|null
	 */
	public function getNamedRange($namedRange, MF_PHPExcel_Worksheet $pSheet = null) {
		$returnValue = null;
	 ...
	 * @return MF_PHPExcel
	 */
	public function removeNamedRange($namedRange, MF_PHPExcel_Worksheet $pSheet = null) {
		if (is_null($pSheet)) {
			if (isset($this->_namedRanges[$namedRange])) {
	 ...
	 *
	 * @return MF_PHPExcel_WorksheetIterator
	 */
	public function getWorksheetIterator() {
		return new MF_PHPExcel_WorksheetIterator($this);
	}
	 ...
	 *
	 * @param string $pValue
	 * @return MF_PHPExcel_Style|false
	 */
	 ...
	 */
	public function addCellXf(MF_PHPExcel_Style $style)
	{
	 ...
	 *
	 * @param MF_PHPExcel_Style $pStyle
	 */
	public function addCellStyleXf(MF_PHPExcel_Style $pStyle)
	{
	...
	public function garbageCollect()
	{
		...
		if (count($this->_cellXfCollection) == 0) {
			$this->_cellXfCollection[] = new MF_PHPExcel_Style();
		}
