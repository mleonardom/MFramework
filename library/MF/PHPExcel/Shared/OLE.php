...
class MF_PHPExcel_Shared_OLE
{
	...
	* use MF_PHPExcel_Shared_OLE_PPS_File::getStream().
	...
	public function getStream($blockIdOrPps)
	{
		...
		if (!$isRegistered) {
			stream_wrapper_register('ole-chainedblockstream',
				'MF_PHPExcel_Shared_OLE_ChainedBlockStream');
			$isRegistered = true;
		}
		...
		if ($blockIdOrPps instanceof MF_PHPExcel_Shared_OLE_PPS) {
	...
	public function _readPpsWks($blockId)
	{
		...
		for ($pos = 0; ; $pos += 128) {
			...
			case self::OLE_PPS_TYPE_ROOT:
				$pps = new MF_PHPExcel_Shared_OLE_PPS_Root(null, null, array());
				$this->root = $pps;
				break;
			case self::OLE_PPS_TYPE_DIR:
				$pps = new MF_PHPExcel_Shared_OLE_PPS(null, null, null, null, null,
								   null, null, null, null, array());
				break;
			case self::OLE_PPS_TYPE_FILE:
				$pps = new MF_PHPExcel_Shared_OLE_PPS_File($name);
				break;
			default:
				continue;
			}
