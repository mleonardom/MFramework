...
/**
 * MF_PHPExcel_Shared_String
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Shared_String
{
	/**	Constants				*/
	/**	Regular Expressions		*/
	//	Fraction
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = MF_PHPExcel_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by MF_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by MF_PHPExcel_Writer_HTML and MF_PHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by MF_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by MF_PHPExcel_Writer_HTML and MF_PHPExcel_Writer_PDF
	 *
