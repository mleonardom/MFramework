...
/**
 * MF_PHPExcel_Shared_Font
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Shared_Font
{
	 ...
	 */
	public static function calculateColumnWidth(MF_PHPExcel_Style_Font $font, $cellText = '', $rotation = 0, MF_PHPExcel_Style_Font $defaultFont = null) {

		// If it is rich text, use plain text
		if ($cellText instanceof MF_PHPExcel_RichText) {
		...
		$columnWidth = MF_PHPExcel_Shared_Drawing::pixelsToCellDimension($columnWidth, $defaultFont);
	 ...
	 *
	 * @param string $text
	 * @param MF_PHPExcel_Style_Font
	 * @param int $rotation
	 * @return int
	 * @throws Exception
	 */
	public static function getTextWidthPixelsExact($text, MF_PHPExcel_Style_Font $font, $rotation = 0) {
	 ...
	 */
	public static function getTextWidthPixelsApprox($columnText, MF_PHPExcel_Style_Font $font = null, $rotation = 0)
	{
		...
		switch ($fontName) {
			case 'Calibri':
				...
				$columnWidth = (int) (8.26 * MF_PHPExcel_Shared_String::CountCharacters($columnText));
				$columnWidth = $columnWidth * $fontSize / 11; // extrapolate from font size
				break;

			case 'Arial':
				// value 7 was found via interpolation by inspecting real Excel files with Arial 10 font.
				$columnWidth = (int) (7 * MF_PHPExcel_Shared_String::CountCharacters($columnText));
				$columnWidth = $columnWidth * $fontSize / 10; // extrapolate from font size
				break;

			case 'Verdana':
				// value 8 was found via interpolation by inspecting real Excel files with Verdana 10 font.
				$columnWidth = (int) (8 * MF_PHPExcel_Shared_String::CountCharacters($columnText));
				$columnWidth = $columnWidth * $fontSize / 10; // extrapolate from font size
				break;
	 ...
	 *
	 * @param MF_PHPExcel_Style_Font $font The workbooks default font
	 * @param boolean $pPixels true = return column width in pixels, false = return in OOXML units
	 * @return mixed Column width
	 */
	public static function getDefaultColumnWidthByFont(MF_PHPExcel_Style_Font $font, $pPixels = false)
	{
	 ...
	 */
	public static function getDefaultRowHeightByFont(MF_PHPExcel_Style_Font $font)
	{
		switch ($font->getName()) {
			case 'Arial':
				switch ($font->getSize()) {
