 ...
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Shared_Escher_DggContainer_BstoreContainer
{
	/**
	 ...
	 *
	 * @param MF_PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE $BSE
	 */
	 ...
	 *
	 * @return MF_PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE[]
	 */
