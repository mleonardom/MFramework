...
/**
 * MF_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return MF_PHPExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof MF_PHPExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
