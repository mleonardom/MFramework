...
/**
 * MF_PHPExcel_Shared_Escher_DggContainer
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return MF_PHPExcel_Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param MF_PHPExcel_Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */
