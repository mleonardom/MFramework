...
/**
 * MF_PHPExcel_Style_Font
 *
 * @category   MF_PHPExcel
 * @package	MF_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style_Font implements MF_PHPExcel_IComparable
{
	/* Underline types */
	 ...
	 * @var string
	 */
	private $_underline		= MF_PHPExcel_Style_Font::UNDERLINE_NONE;
	...
	/**
	 * Create a new MF_PHPExcel_Style_Font
	 */
	 ...
	 *
	 * <code>
	 * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'	  => 'Arial',
	 *			'bold'	  => true,
	 *			'italic'	=> false,
	 ...
	 * Set Underline
	 *
	 * @param string $pValue	MF_PHPExcel_Style_Font underline type
	 * @return MF_PHPExcel_Style_Font
	 */
	public function setUnderline($pValue = MF_PHPExcel_Style_Font::UNDERLINE_NONE) {
		if ($pValue == '') {
			$pValue = MF_PHPExcel_Style_Font::UNDERLINE_NONE;
		}
		if ($this->_isSupervisor) {
