...
/**
 * MF_PHPExcel_Style_Color
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style_Color implements MF_PHPExcel_IComparable
{
	/* Colors */
    ...
    /**
     * Create a new MF_PHPExcel_Style_Color
     *
     * @param string $pARGB
     */
    public function __construct($pARGB = MF_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor = false)
    {
    	// Supervisor?
     ...
     *
     * <code>
     * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
     * </code>
     *
     ...
     * @return MF_PHPExcel_Style_Color
     */
    public function setARGB($pValue = MF_PHPExcel_Style_Color::COLOR_BLACK) {
    	if ($pValue == '') {
    		$pValue = MF_PHPExcel_Style_Color::COLOR_BLACK;
    	}
		if ($this->_isSupervisor) {
    ...
    public static function indexedColor($pIndex) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new MF_PHPExcel_Style_Color(self::$_indexedColors[$pIndex]);
		}

    	return new MF_PHPExcel_Style_Color();
    }
