...
/**
 * MF_PHPExcel_Style_Borders
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style_Borders implements MF_PHPExcel_IComparable
{
	/* Diagonal directions */
	...
	/**
     * Create a new MF_PHPExcel_Style_Borders
     */
    public function __construct($isSupervisor = false)
    {
    	...
    	// Initialise values
    	$this->_left				= new MF_PHPExcel_Style_Border($isSupervisor);
    	$this->_right				= new MF_PHPExcel_Style_Border($isSupervisor);
    	$this->_top					= new MF_PHPExcel_Style_Border($isSupervisor);
    	$this->_bottom				= new MF_PHPExcel_Style_Border($isSupervisor);
    	$this->_diagonal			= new MF_PHPExcel_Style_Border($isSupervisor);
		$this->_diagonalDirection	= MF_PHPExcel_Style_Borders::DIAGONAL_NONE;

		// Specially for supervisor
		if ($isSupervisor) {
			// Initialize pseudo-borders
			$this->_allBorders			= new MF_PHPExcel_Style_Border(true);
			$this->_outline				= new MF_PHPExcel_Style_Border(true);
			$this->_inside				= new MF_PHPExcel_Style_Border(true);
			$this->_vertical			= new MF_PHPExcel_Style_Border(true);
			$this->_horizontal			= new MF_PHPExcel_Style_Border(true);
	 ...
	 *
	 * @param MF_PHPExcel_Style $parent
     ...
     *
     * <code>
     * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->getBorders()->applyFromArray(
     * 		array(
     * 			'bottom'     => array(
     ...
     * Get Left
     *
     * @return MF_PHPExcel_Style_Border
     */
     ...
     * @return MF_PHPExcel_Style_Borders
     */
    public function setDiagonalDirection($pValue = MF_PHPExcel_Style_Borders::DIAGONAL_NONE) {
        if ($pValue == '') {
    		$pValue = MF_PHPExcel_Style_Borders::DIAGONAL_NONE;
    	}
		if ($this->_isSupervisor) {
