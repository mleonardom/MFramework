...
/**
 * MF_PHPExcel_Style_Alignment
 *
 * @category   MF_PHPExcel
 * @package	MF_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style_Alignment implements MF_PHPExcel_IComparable
{
	 ...
	 * @var string
	 */
	private $_horizontal	= MF_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	private $_vertical		= MF_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
	...
	/**
	 * Create a new MF_PHPExcel_Style_Alignment
	 */
	 ...
	 *
	 * <code>
	 * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
	 *		array(
	 *			'horizontal' => MF_PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => MF_PHPExcel_Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'	   => true
	 *		)
	 * );
	 ...
	 * @return MF_PHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = MF_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = MF_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return MF_PHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = MF_PHPExcel_Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = MF_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		// Excel2007 value 255 => MF_PHPExcel value -165
		if ($pValue == 255) {
			$pValue = -165;
		}
