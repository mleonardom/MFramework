...
/**
 * MF_PHPExcel_Style_Protection
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style_Protection implements MF_PHPExcel_IComparable
{
	/** Protection styles */
    ...
    /**
     * Create a new MF_PHPExcel_Style_Protection
     */
     ...
     *
     * <code>
     * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->getLocked()->applyFromArray( array('locked' => true, 'hidden' => false) );
     * </code>
     *
