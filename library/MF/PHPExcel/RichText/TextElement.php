...
/**
 * MF_PHPExcel_RichText_TextElement
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_RichText
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_RichText_TextElement implements MF_PHPExcel_RichText_ITextElement
{
	/**
	 * Text
	 *
    ...
    /**
     * Create a new MF_PHPExcel_RichText_TextElement instance
     *
