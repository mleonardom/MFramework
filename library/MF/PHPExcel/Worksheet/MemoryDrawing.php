...
/**
 * MF_PHPExcel_Worksheet_MemoryDrawing
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_MemoryDrawing extends MF_PHPExcel_Worksheet_BaseDrawing implements MF_PHPExcel_IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new MF_PHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return MF_PHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return MF_PHPExcel_Worksheet_MemoryDrawing
     */
    public function setRenderingFunction($value = MF_PHPExcel_Worksheet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return MF_PHPExcel_Worksheet_MemoryDrawing
     */
    public function setMimeType($value = MF_PHPExcel_Worksheet_MemoryDrawing::MIMETYPE_DEFAULT) {
