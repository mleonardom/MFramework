...
/**
 * MF_PHPExcel_Worksheet_CellIterator
 *
 * Used to iterate rows in a MF_PHPExcel_Worksheet
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_CellIterator extends CachingIterator
{
	/**
	 * MF_PHPExcel_Worksheet to iterate
	 *
	 ...
	 *
	 * @param MF_PHPExcel_Worksheet 		$subject
	 * @param int						$rowIndex
	 */
	public function __construct(MF_PHPExcel_Worksheet $subject = null, $rowIndex = 1) {
    ...
    /**
     * More MF_PHPExcel_Cell instances available?
     *
     * @return boolean
     */
    public function valid() {
        ...
        // position.
        $columnCount = MF_PHPExcel_Cell::columnIndexFromString($this->_subject->getHighestColumn());
