...
/**
 * MF_PHPExcel_Worksheet_SheetView
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_SheetView
{
	/**
	 * ZoomScale
	 *
    ...
    /**
     * Create a new MF_PHPExcel_Worksheet_SheetView
     */
	 ...
	 * @param 	int 	$pValue
	 * @throws 	Exception
	 * @return MF_PHPExcel_Worksheet_SheetView
	 */
