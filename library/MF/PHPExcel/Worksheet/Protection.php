...
/**
 * MF_PHPExcel_Worksheet_Protection
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_Protection
{
	/**
	 * Sheet
	 *
    ...
    /**
     * Create a new MF_PHPExcel_Worksheet_Protection
     */
    ...
    function setPassword($pValue = '', $pAlreadyHashed = false) {
    	if (!$pAlreadyHashed) {
    		$pValue = MF_PHPExcel_Shared_PasswordHasher::hashPassword($pValue);
    	}
