...
/**
 * MF_PHPExcel_Worksheet_PageSetup
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_PageSetup
{
	/* Paper size */
	 ...
	 * @var int
	 */
	private $_paperSize		= MF_PHPExcel_Worksheet_PageSetup::PAPERSIZE_LETTER;
	 ...
	 * @var string
	 */
	private $_orientation	= MF_PHPExcel_Worksheet_PageSetup::ORIENTATION_DEFAULT;
    ...
    /**
     * Create a new MF_PHPExcel_Worksheet_PageSetup
     */
    ...
    {
    	return $this->setPrintArea(MF_PHPExcel_Cell::stringFromColumnIndex($column1) . $row1 . ':' . MF_PHPExcel_Cell::stringFromColumnIndex($column2) . $row2, $index, $method);
    }
    ...
    {
    	return $this->setPrintArea(MF_PHPExcel_Cell::stringFromColumnIndex($column1) . $row1 . ':' . MF_PHPExcel_Cell::stringFromColumnIndex($column2) . $row2, $index, self::SETPRINTRANGE_INSERT);
	}
