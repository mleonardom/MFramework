...
/**
 * MF_PHPExcel_Worksheet_HeaderFooter
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var MF_PHPExcel_Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new MF_PHPExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @param MF_PHPExcel_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws Exception
     * @return MF_PHPExcel_Worksheet_HeaderFooter
     */
    public function addImage(MF_PHPExcel_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param MF_PHPExcel_Worksheet_HeaderFooterDrawing[] $images
     * @throws Exception
     * @return MF_PHPExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @return MF_PHPExcel_Worksheet_HeaderFooterDrawing[]
     */
