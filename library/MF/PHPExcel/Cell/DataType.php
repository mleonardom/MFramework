...
/**
 * MF_PHPExcel_Cell_DataType
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Cell
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Cell_DataType
{
	/* Data types */
	const TYPE_STRING		= 's';
	 ...
	 * DataType for value
	 *
	 * @deprecated Replaced by MF_PHPExcel_Cell_IValueBinder infrastructure
	 * @param	mixed 	$pValue
	 * @return 	int
	 */
	public static function dataTypeForValue($pValue = null) {
		return MF_PHPExcel_Cell_DefaultValueBinder::dataTypeForValue($pValue);
	}
	...
	{
		if ($pValue instanceof MF_PHPExcel_RichText) {
			// TODO: Sanitize Rich-Text string (max. character count is 32,767)
			return $pValue;
		}

		// string must never be longer than 32,767 characters, truncate if necessary
		$pValue = MF_PHPExcel_Shared_String::Substring($pValue, 0, 32767);
