 ...
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Style implements MF_PHPExcel_IComparable
{
	/**
	 * Font
	 *
	 ...
	 * Alignment
	 *
	 * @var MF_PHPExcel_Style_Alignment
	 */
	private $_alignment;
	 ...
	 * Number Format
	 *
	 * @var MF_PHPExcel_Style_NumberFormat
	 */
	 ...
	 * Conditional styles
	 *
	 * @var MF_PHPExcel_Style_Conditional[]
	 */
	 ...
	 * Protection
	 *
	 * @var MF_PHPExcel_Style_Protection
	 */
	private $_protection;
    ...
    /**
     * Create a new MF_PHPExcel_Style
	 *
    ...
    public function __construct($isSupervisor = false)
    {
		...
		$this->_font				= new MF_PHPExcel_Style_Font($isSupervisor);
		$this->_fill				= new MF_PHPExcel_Style_Fill($isSupervisor);
		$this->_borders				= new MF_PHPExcel_Style_Borders($isSupervisor);
		$this->_alignment			= new MF_PHPExcel_Style_Alignment($isSupervisor);
		$this->_numberFormat		= new MF_PHPExcel_Style_NumberFormat($isSupervisor);
		$this->_protection			= new MF_PHPExcel_Style_Protection($isSupervisor);
     ...
     *
     * <code>
     * $objMF_PHPExcel->getActiveSheet()->getStyle('B2')->applyFromArray(
     * 		array(
     * 			'font'    => array(
     * 				'name'      => 'Arial',
     * 				'bold'      => true,
     * 				'italic'    => false,
     * 				'underline' => MF_PHPExcel_Style_Font::UNDERLINE_DOUBLE,
     * 				'strike'    => false,
     * 				'color'     => array(
     * 					'rgb' => '808080'
     * 				)
     ...
     * 			'borders' => array(
     * 				'bottom'     => array(
     * 					'style' => MF_PHPExcel_Style_Border::BORDER_DASHDOT,
     * 					'color' => array(
     * 						'rgb' => '808080'
     * 					)
     * 				),
			...
			if ($this->_isSupervisor) {
				...
				if ($pAdvanced && isset($pStyles['borders'])) {
					...
					for ($x = 1; $x <= $xMax; ++$x) {
						...
						$colStart = ($x == 3) ?
							MF_PHPExcel_Cell::stringFromColumnIndex($rangeEnd[0])
								: MF_PHPExcel_Cell::stringFromColumnIndex($rangeStart[0] + $x - 1);

						// end column index for region
						$colEnd = ($x == 1) ?
							MF_PHPExcel_Cell::stringFromColumnIndex($rangeStart[0])
								: MF_PHPExcel_Cell::stringFromColumnIndex($rangeEnd[0] - $xMax + $x);
	 ...
	 * Set font
	 *
	 * @param MF_PHPExcel_Style_Font $font
	 * @return MF_PHPExcel_Style
	 */
	public function setFont(MF_PHPExcel_Style_Font $font)
	{
		$this->_font = $font;
		return $this;
	}
     ...
     * Get Borders
     *
     * @return MF_PHPExcel_Style_Borders
     */
     ...
     * Get Alignment
     *
     * @return MF_PHPExcel_Style_Alignment
     */
     ...
     * Get Number Format
     *
     * @return MF_PHPExcel_Style_NumberFormat
     */
     ...
     *
     * @param MF_PHPExcel_Style_Conditional[]	$pValue	Array of condtional styles
     * @return MF_PHPExcel_Style
     */
     ...
     * Get Protection
     *
     * @return MF_PHPExcel_Style_Protection
     */
