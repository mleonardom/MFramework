...
/**
 * MF_PHPExcel_Writer_Excel2007
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Writer_Excel2007 implements MF_PHPExcel_Writer_IWriter
{
	/**
	 ...
	 *
	 * @var MF_PHPExcel_Writer_Excel2007_WriterPart[]
	 */
	...
	/**
	 * Private unique MF_PHPExcel_Style_Conditional HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
	private $_stylesConditionalHashTable;

	/**
	 * Private unique MF_PHPExcel_Style_Fill HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique MF_PHPExcel_Style_Font HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique MF_PHPExcel_Style_Borders HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique MF_PHPExcel_Style_NumberFormat HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique MF_PHPExcel_Worksheet_BaseDrawing HashTable
	 *
	 * @var MF_PHPExcel_HashTable
	 */
    ...
    /**
     * Create a new MF_PHPExcel_Writer_Excel2007
     *
    ...
    public function __construct(MF_PHPExcel $pMF_PHPExcel = null)
    {
    	...
    	$this->_writerParts['stringtable']		= new MF_PHPExcel_Writer_Excel2007_StringTable();
		$this->_writerParts['contenttypes'] 	= new MF_PHPExcel_Writer_Excel2007_ContentTypes();
		$this->_writerParts['docprops'] 		= new MF_PHPExcel_Writer_Excel2007_DocProps();
		$this->_writerParts['rels'] 			= new MF_PHPExcel_Writer_Excel2007_Rels();
		$this->_writerParts['theme'] 			= new MF_PHPExcel_Writer_Excel2007_Theme();
		$this->_writerParts['style'] 			= new MF_PHPExcel_Writer_Excel2007_Style();
		$this->_writerParts['workbook'] 		= new MF_PHPExcel_Writer_Excel2007_Workbook();
		$this->_writerParts['worksheet'] 		= new MF_PHPExcel_Writer_Excel2007_Worksheet();
		$this->_writerParts['drawing'] 			= new MF_PHPExcel_Writer_Excel2007_Drawing();
		$this->_writerParts['comments'] 		= new MF_PHPExcel_Writer_Excel2007_Comments();
		...
		$this->_stylesConditionalHashTable 	= new MF_PHPExcel_HashTable();
		$this->_fillHashTable 				= new MF_PHPExcel_HashTable();
		$this->_fontHashTable 				= new MF_PHPExcel_HashTable();
		$this->_bordersHashTable 			= new MF_PHPExcel_HashTable();
		$this->_numFmtHashTable 			= new MF_PHPExcel_HashTable();
		$this->_drawingHashTable 			= new MF_PHPExcel_HashTable();
    }
	 ...
	 * @return 	MF_PHPExcel_Writer_Excel2007_WriterPart
	 */
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
				if ($this->getDrawingHashTable()->getByIndex($i) instanceof MF_PHPExcel_Worksheet_Drawing) {
					$imageContents = null;
				...
				} else if ($this->getDrawingHashTable()->getByIndex($i) instanceof MF_PHPExcel_Worksheet_MemoryDrawing) {
					ob_start();
					call_user_func(
	...
	/**
	 * Set MF_PHPExcel object
	 *
	 * @param 	MF_PHPExcel 	$pMF_PHPExcel	MF_PHPExcel object
	 * @throws	Exception
	 * @return MF_PHPExcel_Writer_Excel2007
	 */
    ...
    /**
     * Get MF_PHPExcel_Style_Conditional HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
    ...
    /**
     * Get MF_PHPExcel_Style_Fill HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
    ...
    /**
     * Get MF_PHPExcel_Style_Font HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
    ...
    /**
     * Get MF_PHPExcel_Style_Borders HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
    ...
    /**
     * Get MF_PHPExcel_Style_NumberFormat HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
    ...
    /**
     * Get MF_PHPExcel_Worksheet_BaseDrawing HashTable
     *
     * @return MF_PHPExcel_HashTable
     */
