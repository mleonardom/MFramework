...
/**
 * MF_PHPExcel_Writer_Excel2007_Comments
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Writer_Excel2007_Comments extends MF_PHPExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 * @throws 	Exception
	 */
	public function writeComments(MF_PHPExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @param 	MF_PHPExcel_Comment				$pComment			Comment
	 * @param	array							$pAuthors			Array of authors
	 * @throws 	Exception
	 */
	public function _writeComment(MF_PHPExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', MF_PHPExcel_Comment $pComment = null, $pAuthors = null)
	{
		// comment
	 ...
	 * @throws 	Exception
	 */
	public function writeVMLComments(MF_PHPExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
	 ...
	 * @throws 	Exception
	 */
	public function _writeVMLComment(MF_PHPExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', MF_PHPExcel_Comment $pComment = null)
	{
 		// Metadata
 		list($column, $row) = MF_PHPExcel_Cell::coordinateFromString($pCellReference);
 		$column = MF_PHPExcel_Cell::columnIndexFromString($column);
 		$id = 1024 + $column + $row;
 		$id = substr($id, 0, 4);
