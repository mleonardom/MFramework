...
/**
 * MF_PHPExcel_Writer_Excel5_Font
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Writer_Excel5_Font
{
	/**
	 * BIFF version
	 *
	 ...
	 */
	public function __construct(MF_PHPExcel_Style_Font $font = null)
	{
	...
	public function writeFont()
	{
		...
		$bCharSet = MF_PHPExcel_Shared_Font::getCharsetFromFontName($this->_font->getName()); // Character set
		...
		if ($this->_BIFFVersion == 0x0500) {
			...
			$data .= MF_PHPExcel_Shared_String::UTF8toBIFF8UnicodeShort($this->_font->getName());
		}
	...
	private function _mapUnderline($underline) {
		switch ($underline) {
			case MF_PHPExcel_Style_Font::UNDERLINE_NONE:				return 0x00;
			case MF_PHPExcel_Style_Font::UNDERLINE_SINGLE:				return 0x01;
			case MF_PHPExcel_Style_Font::UNDERLINE_DOUBLE:				return 0x02;
			case MF_PHPExcel_Style_Font::UNDERLINE_SINGLEACCOUNTING:	return 0x21;
			case MF_PHPExcel_Style_Font::UNDERLINE_DOUBLEACCOUNTING:	return 0x22;
			default:												return 0x00;
		}
	}
