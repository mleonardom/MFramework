...
/**
 * MF_PHPExcel_Writer_Excel5_Xf
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Writer_Excel5_Xf
{
	/**
	 * BIFF version
	 *
	...
	*/
	 ...
	 * @param MF_PHPExcel_Style
	 */
	public function __construct(MF_PHPExcel_Style $style = null)
	{
	...
	function writeXf()
	{
		...
		if ($this->_BIFFVersion == 0x0500) {
			...
			$diag_tl_to_rb = $diagonalDirection == MF_PHPExcel_Style_Borders::DIAGONAL_BOTH
								|| $diagonalDirection == MF_PHPExcel_Style_Borders::DIAGONAL_DOWN;
			$diag_tr_to_lb = $diagonalDirection == MF_PHPExcel_Style_Borders::DIAGONAL_BOTH
								|| $diagonalDirection == MF_PHPExcel_Style_Borders::DIAGONAL_UP;
	...
	private function _mapBorderStyle($borderStyle) {
		switch ($borderStyle) {
			case MF_PHPExcel_Style_Border::BORDER_NONE:				return 0x00;
			case MF_PHPExcel_Style_Border::BORDER_THIN;				return 0x01;
			case MF_PHPExcel_Style_Border::BORDER_MEDIUM;				return 0x02;
			case MF_PHPExcel_Style_Border::BORDER_DASHED;				return 0x03;
			case MF_PHPExcel_Style_Border::BORDER_DOTTED;				return 0x04;
			case MF_PHPExcel_Style_Border::BORDER_THICK;				return 0x05;
			case MF_PHPExcel_Style_Border::BORDER_DOUBLE;				return 0x06;
			case MF_PHPExcel_Style_Border::BORDER_HAIR;				return 0x07;
			case MF_PHPExcel_Style_Border::BORDER_MEDIUMDASHED;		return 0x08;
			case MF_PHPExcel_Style_Border::BORDER_DASHDOT;				return 0x09;
			case MF_PHPExcel_Style_Border::BORDER_MEDIUMDASHDOT;		return 0x0A;
			case MF_PHPExcel_Style_Border::BORDER_DASHDOTDOT;			return 0x0B;
			case MF_PHPExcel_Style_Border::BORDER_MEDIUMDASHDOTDOT;	return 0x0C;
			case MF_PHPExcel_Style_Border::BORDER_SLANTDASHDOT;		return 0x0D;
			default:												return 0x00;
		}
	}
	...
	private function _mapFillType($fillType) {
		switch ($fillType) {
			case MF_PHPExcel_Style_Fill::FILL_NONE:					return 0x00;
			case MF_PHPExcel_Style_Fill::FILL_SOLID:					return 0x01;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_MEDIUMGRAY:		return 0x02;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKGRAY:		return 0x03;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRAY:		return 0x04;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKHORIZONTAL:	return 0x05;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKVERTICAL:	return 0x06;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKDOWN:		return 0x07;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKUP:			return 0x08;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKGRID:		return 0x09;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_DARKTRELLIS:		return 0x0A;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL:	return 0x0B;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTVERTICAL:	return 0x0C;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTDOWN:		return 0x0D;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTUP:			return 0x0E;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRID:		return 0x0F;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTTRELLIS:	return 0x10;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_GRAY125:			return 0x11;
			case MF_PHPExcel_Style_Fill::FILL_PATTERN_GRAY0625:		return 0x12;
			case MF_PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR:		// does not exist in BIFF8
			case MF_PHPExcel_Style_Fill::FILL_GRADIENT_PATH:		// does not exist in BIFF8
			default:												return 0x00;
		}
	}
	...
	{
		switch ($hAlign) {
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL:				return 0;
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_LEFT:					return 1;
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_CENTER:				return 2;
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_RIGHT:				return 3;
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY:				return 5;
			case MF_PHPExcel_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS:	return 6;
			default:														return 0;
		}
	}
	...
	private function _mapVAlign($vAlign) {
		switch ($vAlign) {
			case MF_PHPExcel_Style_Alignment::VERTICAL_TOP:		return 0;
			case MF_PHPExcel_Style_Alignment::VERTICAL_CENTER:		return 1;
			case MF_PHPExcel_Style_Alignment::VERTICAL_BOTTOM:		return 2;
			case MF_PHPExcel_Style_Alignment::VERTICAL_JUSTIFY:	return 3;
			default:											return 2;
		}
	}
	...
	private function _mapLocked($locked) {
		switch ($locked) {
			case MF_PHPExcel_Style_Protection::PROTECTION_INHERIT:		return 1;
			case MF_PHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case MF_PHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private function _mapHidden($hidden) {
		switch ($hidden) {
			case MF_PHPExcel_Style_Protection::PROTECTION_INHERIT:		return 0;
			case MF_PHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case MF_PHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}
