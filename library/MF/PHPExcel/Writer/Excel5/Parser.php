...
/**
 * MF_PHPExcel_Writer_Excel5_Parser
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Writer_Excel5_Parser
{
	/**	Constants				*/
	...
	function _convertString($string)
	{
		...
		if ($this->_BIFF_version == 0x0500) {
			...
			return pack('C', $this->ptg['ptgStr']) . MF_PHPExcel_Shared_String::UTF8toBIFF8UnicodeShort($string);
		}
	}
	 ...
	 * MF_PHPExcel_Writer_Excel5_Workbook class.
	 *
	 * @access private
	 ...
	 *
	 * @access public
	 * @see MF_PHPExcel_Writer_Excel5_Workbook::addWorksheet()
