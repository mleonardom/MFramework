...
/**
 * MF_PHPExcel_Calculation_Functions
 *
 * @category	MF_PHPExcel
 * @package		MF_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Calculation_Functions {
	 ...
	 *													MF_PHPExcel_Calculation_Functions::COMPATIBILITY_EXCEL			'Excel'
	 *													MF_PHPExcel_Calculation_Functions::COMPATIBILITY_GNUMERIC		'Gnumeric'
	 *													MF_PHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE	'OpenOfficeCalc'
	 ...
	 *												Permitted values are:
	 *													MF_PHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC		'P'
	 *													MF_PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT		'O'
	 *													MF_PHPExcel_Calculation_Functions::RETURNDATE_EXCEL			'E'
	 *	@return	 boolean							Success or failure
	 */
	...
	public static function _ifCondition($condition) {
		$condition	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($condition);
		if (!in_array($condition{0},array('>', '<', '='))) {
			if (!is_numeric($condition)) { $condition = MF_PHPExcel_Calculation::_wrapResult(strtoupper($condition)); }
			return '='.$condition;
		} else {
			preg_match('/([<>=]+)(.*)/',$condition,$matches);
			list(,$operator,$operand) = $matches;
			if (!is_numeric($operand)) { $operand = MF_PHPExcel_Calculation::_wrapResult(strtoupper($operand)); }
	...
	public static function VERSION() {
		return 'MF_PHPExcel 1.7.5, 2010-12-10';
	}	//	function VERSION()
