...
/**
 * MF_PHPExcel_Calculation_Engineering
 *
 * @category	MF_PHPExcel
 * @package		MF_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Calculation_Engineering {
	...
	public static function BESSELI($x, $n) {
		$x	= (is_null($x))	? 0.0 :	MF_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$n	= (is_null($n))	? 0.0 :	MF_PHPExcel_Calculation_Functions::flattenSingleValue($n);
		...
		if ((is_numeric($x)) && (is_numeric($n))) {
			...
			if (abs($x) <= 30) {
				$fTerm = pow($x / 2, $n) / MF_PHPExcel_Calculation_MathTrig::FACT($n);
				$nK = 1;
				$fResult = $fTerm;
				$fSqrX = ($x * $x) / 4;
				do {
	...
	public static function BESSELK($x, $ord) {
		$x		= (is_null($x))		? 0.0 :	MF_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$ord	= (is_null($ord))	? 0.0 :	MF_PHPExcel_Calculation_Functions::flattenSingleValue($ord);
...
//			$fRet = sqrt(M_2DIVPI / $fNum) * sin($fNum - 2.356194491);
	...
	public static function BINTOHEX($x, $places=null) {
		$x	= floor(MF_PHPExcel_Calculation_Functions::flattenSingleValue($x));
		$places	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($places);
	...
	public static function COMPLEX($realNumber=0.0, $imaginary=0.0, $suffix='i') {
		$realNumber	= (is_null($realNumber))	? 0.0 :	(float) MF_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
		$imaginary	= (is_null($imaginary))		? 0.0 :	(float) MF_PHPExcel_Calculation_Functions::flattenSingleValue($imaginary);
		$suffix		= (is_null($suffix))		? 'i' :	MF_PHPExcel_Calculation_Functions::flattenSingleValue($suffix);
	...
	public static function IMAGINARY($complexNumber) {
		$complexNumber	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMPOWER($complexNumber,$realNumber) {
		$complexNumber	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
		$realNumber		= MF_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
	...
	public static function IMDIV($complexDividend,$complexDivisor) {
		$complexDividend	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexDividend);
		$complexDivisor	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexDivisor);
	...
	public static function IMSUB($complexNumber1,$complexNumber2) {
		$complexNumber1	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber1);
		$complexNumber2	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber2);
	...
	public static function GESTEP($number, $step=0) {
		...
		$step	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($step);
	...
	public static function ERF($lower, $upper = null) {
		$lower	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($lower);
		$upper	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($upper);
	...
	public static function CONVERTUOM($value, $fromUOM, $toUOM) {
		...
		$fromUOM	= MF_PHPExcel_Calculation_Functions::flattenSingleValue($fromUOM);
		$toUOM		= MF_PHPExcel_Calculation_Functions::flattenSingleValue($toUOM);
