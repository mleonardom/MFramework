...
/**
 * MF_PHPExcel_Calculation_ExceptionHandler
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_Calculation
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_Calculation_ExceptionHandler {
	/**
	 * Register errorhandler
	 */
	public function __construct() {
		set_error_handler(array('MF_PHPExcel_Calculation_Exception', 'errorHandlerCallback'), E_ALL);
	}
