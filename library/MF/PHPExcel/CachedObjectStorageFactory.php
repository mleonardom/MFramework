...
class MF_PHPExcel_CachedObjectStorageFactory {
	...
	public static function initialize($method = self::cache_in_memory, $arguments = array()) {
		...
		if (is_null(self::$_cacheStorageMethod)) {
			self::$_cacheStorageClass = 'MF_PHPExcel_CachedObjectStorage_'.$method;
	...
	public static function getInstance(MF_PHPExcel_Worksheet $parent) {
		if (is_null(self::$_cacheStorageMethod)) {
			self::initialize();
		}
