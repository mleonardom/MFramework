...
/**
 * MF_PHPExcel_CachedObjectStorage_Memcache
 *
 * @category   MF_PHPExcel
 * @package    MF_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2010 MF_PHPExcel (http://www.codeplex.com/MF_PHPExcel)
 */
class MF_PHPExcel_CachedObjectStorage_Memcache extends MF_PHPExcel_CachedObjectStorage_CacheBase implements MF_PHPExcel_CachedObjectStorage_ICache {
	...
	/**
	 *	Is a value set in the current MF_PHPExcel_CachedObjectStorage_ICache for an indexed cell?
	 *
	...
	public function __construct(MF_PHPExcel_Worksheet $parent, $arguments) {
